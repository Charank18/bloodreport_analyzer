...
# ✅ Set OpenAI key in environment for LiteLLM & CrewAI compatibility

from tools import search_tool, BloodTestReportTool
import openai
from crewai import Agent

# Optional: Still set openai.api_key for your custom wrapper
openai.api_key = os.environ["OPENAI_API_KEY"]

# If you still want your own wrapper:
class OpenAILLMWrapper:
    def __init__(self, model="gpt-4o-mini", temperature=0.7, max_tokens=500):
        self.openai = openai
        self.model = model
...
llm = OpenAILLMWrapper(model="gpt-4o-mini")
